...
async def lightrag_retrieve(query: str, region: str, mode: str = "hybrid", enable_rerank: bool = False):
    ...
    try:
        ...
        logger.info(f"[LightRAG] Retrieved response for query '{query}' in {region}")
        return resp
    finally:
